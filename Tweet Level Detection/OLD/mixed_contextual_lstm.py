...
def create_bot_tweet_dataset_indiana(i = 0):
    ...
    savenames = ["bot_sample_astroturf.p", "bot_sample_cresci-rtbust-2019.p", "bot_sample_gilani-2017.p", "bot_sample_midterm_2018.p", "bot_sample_political-bots-2019.p", "bot_samplevarol-2017.p"]
